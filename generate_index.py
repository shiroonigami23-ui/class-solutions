...
def generate_file_html(file_info, contributors):
    title = format_title(file_info['name']); contributor_name = contributors.get(file_info['name'])
    ...
    return f"""
    <div class="file-card file-row" data-keywords="{title} {file_info['course']}" data-course="{file_info['course']}">
